...
function getMockCareerResponse(skillsInput: any) {
    ...
    jobOptions: [
      {
        ...
        responsibilities:
          "Design, build, and maintain end-to-end web applications using client-side and server-side technologies.",
        why: `Your experience with ${
          skillsList[0] || "React"
        } and ${
          skillsList[1] || "Node.js"
        } makes you an excellent fit for modern JavaScript/TypeScript full stack environments.`,
      },
      {
        title: "Frontend Development Specialist",
        responsibilities:
          "Create responsive, high-performance user interfaces and collaborate with designers on user experience.",
        why: `You have solid foundational skills like ${
          skillsList[0] || "React"
        } which are highly sought after for modern UI engineering.`,
      },
      {
        title: "Backend / API Engineer",
        responsibilities:
          "Develop scalable server-side systems, design databases, and orchestrate service APIs.",
        why: `Using ${
          skillsList[1] || "Node.js"
        } and associated backend practices enables you to engineer performant logic and service integrations.`,
      },
    ],
    skillsToLearn: [
      {
  ...
  return {
    ...
    scoreBreakdown: {
      formatting: {
        score: 88,
        feedback:
          "Your resume layout is clean and uses standard fonts, which is easily parsed by modern ATS scanners.",
      },
      keywords: {
        score: 78,
        feedback:
          "Good coverage of core web development keywords. Adding cloud and DevOps related keywords would increase your score.",
      },
      structure: {
        score: 85,
        feedback:
          "Standard chronological sections are used. Ensure education and experience sections are clearly demarcated.",
      },
      readability: {
        score: 86,
        feedback:
          "Bullet points are concise. Focus on using more quantifiable achievements (e.g. 'improved performance by 25%').",
      },
    },
    suggestions: [
      {
        ...
        recommendation:
          "Add terms like Docker, CI/CD, AWS, or Kubernetes if you have experience with them.",
        priority: "high",
      },
      {
        category: "Formatting",
        ...
        recommendation:
          "Ensure all dates follow a consistent format like 'MM/YYYY' or 'Month YYYY'.",
        priority: "medium",
      },
      {
        category: "Content",
        ...
        recommendation:
          "Use the STAR method: Situation, Task, Action, Result. Quantify results where possible.",
        priority: "medium",
      },
    ],
    strengths: [
    ...
    summary:
      "Your resume performs very well against standard ATS criteria. Addressing the missing technical keywords and formatting dates uniformly will make it highly competitive.",
  };
}
